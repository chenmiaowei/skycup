...
<div class="boxed">
	...
	<?php if($this->cid == 22){ ?>
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" id="titlef" name="titlef" value="<?php echo set_value("titlef",$it['titlef']) ?>">
			</div>
		</div>
	<?php } ?>	
	...
	<?php if($this->cid == 6){ ?>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" id="addr" name="addr" class='span4' value="<?php echo set_value("addr",$it['addr']) ?>">
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" id="longitude" name="longitude" value="<?php echo set_value("longitude",$it['longitude']) ?>">
	...
	<?php if($this->cid == 18){ ?>
			<div class="control-group">
				...
				<div class="controls">
					<textarea name="shortint" rows='8' class='span4'> <?php echo set_value('shortint',$it['shortint']) ?> </textarea>
					<span class="help-inline"></span>
				</div>
			</div>		
	<?php } ?>	
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="btn-group">
						...
						<input type="hidden" name="xphoto" class="form-upload" data-more="0" value="<?php echo set_value('xphoto',$it['xphoto']) ?>">
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="btn-group">
						...
						<input type="hidden" name="pic" class="form-upload" data-more="0" value="<?php echo set_value('pic',$it['pic']) ?>">
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="btn-group">
						...
						<input type="hidden" name="mphoto" class="form-upload" data-more="0" value="<?php echo set_value('mphoto',$it['mphoto']) ?>">
