<div class="btn-group">
    <a href="<?php echo site_urlc($this->class . '/index') ?>" class='btn'> <i
    ...
    <div class="boxed-inner seamless">
        ...
        <?php if ($this->cid == 26) { ?>
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="title_en" name="title_en" value="<?php echo set_value('title_en') ?>"
                           placeholder="英文名称">
                </div>
            </div>
        <?php } ?>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <div class="btn-group">
                    ...
                    <input type="hidden" name="photo" class="form-upload" <?php if ($this->cid == 1){ ?>data-more='1'
                           <?php }else{ ?>data-more='0'<?php } ?> value="<?php echo set_value('photo') ?>">
                    <input type="hidden" name="thumb" class="form-upload-thumb"
                           value="<?php echo set_value('thumb') ?>">
                </div>
                <?php if ($this->cid == 1) { ?>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <div class="btn-group">
                        ...
                        <input type="hidden" name="mphoto" class="form-upload"
                               <?php if ($this->cid == 1){ ?>data-more='1' <?php }else{ ?>data-more='0'<?php } ?>
                               value="<?php echo set_value('mphoto') ?>">
                    </div>
                    <?php if ($this->cid == 1) { ?>
