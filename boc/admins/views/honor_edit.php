...
<div class="boxed">
	...
	<div class="boxed-inner seamless">
		...
		<div class="control-group">
			...
			<div class="controls">
			<input type="text" class='span4' name="title" id="title" value="<?php echo set_value('title',$it['title']); ?>">
		...
		<div class="control-group">
			<label for="ftitle" class="control-label">副标题:</label>
			<div class="controls">
			<input type="text" class='span4' name="ftitle" id="ftitle" value="<?php echo set_value('ftitle',$it['ftitle']); ?>">
			</div>
		</div>
