...
<div class="boxed">
    ...
    <div class="boxed-inner seamless">
        ...
        <?php if ($this->cid == 18 || $this->cid == 3 || $this->cid == 4 || $this->cid == 5 || $this->cid == 22 || $this->cid == 23) { ?>
            <div class="control-group">
                <label for="introduction" class="control-label">简介内容</label>
                <div class="controls">
                    <textarea name="introduction" rows='8'
                              class='span4'> <?php echo set_value('introduction') ?> </textarea>
                    <span class="help-inline"></span>
                </div>
            </div>
        <?php } ?>

        <?php if ($this->cid != 18 and $this->cid != 6 && $this->cid != 23) { ?>
                ...
                <div class="controls">
                    <div class="btn-group">
                        ...
                        <input type="hidden" name="xphoto" class="form-upload" data-more="0"
                               value="<?php echo set_value("xphoto") ?>">
...
<script type="text/javascript">
    require(['adminer/js/ui', 'adminer/js/media', 'bootstrap-datetimepicker.zh'], function (ui, media) {
        ...
        // ueditor处理
        <?php if($this->cid != 18 && $this->cid != 23){ ?>
