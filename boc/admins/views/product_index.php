...
<table class="table table-striped table-hover select-list">
    ...
    <tbody class="sort-list">
        ...
        <tr data-id="<?php echo $v['id'] ?>" data-sort="<?php echo $v['sort_id'] ?>">
            ...
            <?php if (!$this->ccid): ?>
			<td>
			<a href="<?php echo site_url('page/index?c='.$this->cid.'&cc='.$v['id']) ?>"> 第二屏 </a>
			| <a href="<?php echo site_url('gallery/index?c='.$this->cid.'&cc='.$v['id']) ?>"> 第三屏 </a>
			| <a href="<?php echo site_url('article/index?c='.$this->cid.'&cc='.$v['id']) ?>"> 第四屏 </a>
			| <a href="<?php echo site_url('columnpic/index?c='.$this->cid.'&cc='.$v['id']) ?>"> 第五屏 </a>
			</td>
			<?php endif ?>
