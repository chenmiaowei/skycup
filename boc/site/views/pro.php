        ...
        <div class="pro-box f-cb">
            ...
            <a class="fl pro-text" href="<?php echo site_url('details/'.$v['id']); ?>">
                ...
                <div class="pro-content">
                    <div class="pro-icon">
                        <img src="<?php echo UPLOAD_URL.tag_photo($v['xphoto']); ?>" alt="<?php echo $v['title'] ?>">
                    </div>
            ...
            <!-- 1260*990 -->
            <div class="pro-img fr" style="background: url(<?php echo UPLOAD_URL.tag_photo($v['photo']); ?>) no-repeat center; background-size: cover;"></div>
        </div>
    <?php } ?>
    <?php endforeach ?>
        ...
        <div class="pro-list h5">
            <div class="pro-box f-cb">
                ...
                <a class="fl pro-text" href="<?php echo site_url('details/'.$list[$k+1]['id']); ?>">
                    ...
                    <div class="pro-content">
                        <div class="pro-icon">
                            <img src="<?php echo UPLOAD_URL.tag_photo($list[$k+1]['xphoto']); ?>" alt="<?php echo $list[$k+1]['title'] ?>">
                        </div>
                ...
                <!-- 1260*1080 -->
                <div class="pro-img fr" style="background: url(<?php echo UPLOAD_URL.tag_photo($list[$k+1]['photo']); ?>) no-repeat center; background-size: cover;"></div>
            </div>
        </div>
...
<!-- start 列表页小标题 -->
    <div class="pc">
        ...
        <?php foreach ($ctypelist as $k => $v): ?>
            <div class="sub-nav-box"><a href="<?php echo site_url('pro?type='.$v['id']); ?>" <?php if($v['id']==$type){ echo 'class="active"';} ?>><?php echo $v['title'] ?></a></div>
        <?php endforeach ?>
        </div>
    </div>
    <!-- start 列表页小标题 -->
