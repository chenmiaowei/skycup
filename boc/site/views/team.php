...
<div class="h5">
    ...
    <div class="team-list f-cb pc">
        ...
        <?php foreach ($list as $k => $v): ?>
            <a href="<?php echo site_url('teamDetails/'.$v['id']); ?>" class="team-box fl" style="background: url(<?php echo UPLOAD_URL.tag_photo($v['photo']); ?>) no-repeat center; background-size: cover;">
                <span class="team-name"><?php echo $v['title'] ?></span>
            </a>
        <?php if($k > 2){ break; } endforeach ?>
